...
import com.legends.edumia.entity.animals.util.ai.HybridPathNavigator;
...
public abstract class EntityCrocidilian extends EntityAnimalWithTypes implements Enemy, IPeacefulAware {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new PeacefulNearestAttackableTargetGoal<>(this, Player.class,
                15, false, false,
                e -> !e.isPassenger()));
    }
    ...
    protected PathNavigation createNavigation(Level worldIn) {
        return new HybridPathNavigator<>(this, worldIn, e -> e.getTarget() == null || (e.getTarget().isInWater() &&
                this.isInWater()) || (!e.getTarget().isInWater() && this.isInWater()));
    }
