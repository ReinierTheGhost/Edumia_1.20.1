package com.legends.edumia.entity.animals.util.ai;
...
public class PeacefulNearestAttackableTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
    ...
    public PeacefulNearestAttackableTargetGoal(Mob goalOwnerIn, Class<T> targetClassIn, int targetChanceIn, boolean checkSight,
    ...
    public boolean canUse() {
        return (this.mob instanceof IPeacefulAware) ? !((IPeacefulAware) this.mob).isPeaceful() : this.mob.level().getDifficulty()
                != Difficulty.PEACEFUL && super.canUse();
    }
}
