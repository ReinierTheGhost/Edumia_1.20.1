...
public class EntityAIEatBerries extends MoveToBlockGoal {
    ...
    protected boolean isValidTarget(LevelReader worldIn, BlockPos pos) {
        ...
        return blockstate.getBlock() == Blocks.SWEET_BERRY_BUSH && blockstate.getValue(SweetBerryBushBlock.AGE)
                >= 2;
    }
    ...
    protected void eatBerry() {
        if(ModPlatformEvents.mobGrief(this.mob.level(), this.mob)) {
            ...
            if(blockstate.getBlock() == Blocks.SWEET_BERRY_BUSH) {
                ...
                this.mob.level().setBlock(this.blockPos, blockstate.setValue(SweetBerryBushBlock.AGE, 1), 
                        2);
            }
        }
    }
