...
@Assets(
        ...
        block = {@Model(
                ...
                template = "block/parent_wall_post"
        ), @Model(
                name = "block/%s_wall_n",
                template = "block/parent_wall_n"
        ), @Model(
                name = "block/%s_wall_ne",
                template = "block/parent_wall_ne"
        ), @Model(
                name = "block/%s_wall_nse",
                template = "block/parent_wall_nse"
        ), @Model(
                name = "block/%s_wall_nsew",
                template = "block/parent_wall_nsew"
        ), @Model(
                name = "block/%s_wall_ns",
                template = "block/parent_wall_ns"
        ), @Model(
                name = "block/%s_wall_ns_above",
                template = "block/parent_wall_ns_above"
        ), @Model(
