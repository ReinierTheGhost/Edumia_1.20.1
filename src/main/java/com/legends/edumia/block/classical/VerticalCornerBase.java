...
@Assets(
        state = @State(
                ...
                template = "parent_doric_base_vertical_corner"
        ),
        item = @Model(
        ...
        block = {@Model(
                ...
                template = "block/parent_doric_base_vertical_corner_2"
        ), @Model(
                name = "block/%s_vertical_corner_4",
                template = "block/parent_doric_base_vertical_corner_4"
        ), @Model(
                name = "block/%s_vertical_corner_6",
                template = "block/parent_doric_base_vertical_corner_6"
        )}
)
