...
import com.legends.edumia.entity.animations.ModAnimationDefinitions;
...
public class ModelRhino<T extends EntityRhino> extends HierarchicalModel<T> {
	private final ModelPart rhino;
	private final ModelPart head;

	public ModelRhino(ModelPart root) {
	...
	@Override
	public void setupAnim(EntityRhino entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(EntityRhino pEntity, float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
