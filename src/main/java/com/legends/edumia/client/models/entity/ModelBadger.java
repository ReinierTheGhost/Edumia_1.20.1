...
public class ModelBadger<T extends LivingEntity> extends EdumiaModels<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition lowerBack = partdefinition.addOrReplaceChild("lowerBack", CubeListBuilder.create().texOffs(0, 15)
                .addBox(-4.5F, -4.7F, 0.0F, 9.0F, 8.0F, 10.0F,
                        new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 15.5F, -1.0F, -0.0456F, 0.0F, 0.0F));

        PartDefinition front = lowerBack.addOrReplaceChild("front", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-4.0F, -4.0F, -10.0F, 8.0F, 7.0F, 7.0F,
                        new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -0.5F, 3.4F, 0.0911F, 0.0F, 0.0F));

        PartDefinition neck = front.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 34)
                .addBox(-3.0F, -3.0F, -4.0F, 6.0F, 6.0F, 4.0F,
                        new CubeDeformation(0.1F)),
                PartPose.offsetAndRotation(0.0F, -0.7F, -9.0F, -0.182F, 0.0F, 0.0F));
