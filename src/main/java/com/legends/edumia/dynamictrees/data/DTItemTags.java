package com.legends.edumia.dynamictrees.data;
...
public final class DTItemTags {
    ...
    /**
     * Items that apply the {@link //GrowthSubstance growth substance}
     * to trees.
     */
    ...
    private static TagKey<Item> bind(String identifier) {
        return ItemTags.create(new ResourceLocation(Edumia.MODID, identifier));
    }
}
