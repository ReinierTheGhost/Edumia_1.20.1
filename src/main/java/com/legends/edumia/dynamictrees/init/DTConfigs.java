...
//    public static final ForgeConfigSpec.IntValue MAX_BRANCH_ROT_RADIUS;
    ...
    //public static final ForgeConfigSpec.EnumValue<Edumia.SwampOakWaterState> SWAMP_OAKS_IN_WATER;
    ...
    public static final ForgeConfigSpec.EnumValue<Edumia.AxeDamage> AXE_DAMAGE_MODE;
...
//                defineEnum("swampOaksInWater", Edumia.SwampOakWaterState.ROOTED);
        ...
        AXE_DAMAGE_MODE = SERVER_BUILDER.comment("Damage dealt to the axe item when cutting a tree down. VANILLA: Standard 1 Damage. THICKNESS: By Branch/Trunk Thickness. VOLUME: By Tree Volume.").
                defineEnum("axeDamageMode", Edumia.AxeDamage.THICKNESS);
