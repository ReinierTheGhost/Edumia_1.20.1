...
import com.legends.edumia.dynamictrees.api.FutureBreakable;
...
import com.legends.edumia.dynamictrees.systems.nodemapper.DestroyerNode;
import com.legends.edumia.dynamictrees.systems.nodemapper.NetVolumeNode;
import com.legends.edumia.dynamictrees.systems.nodemapper.SpeciesNode;
import com.legends.edumia.dynamictrees.systems.nodemapper.StateNode;
import com.legends.edumia.dynamictrees.tree.family.Family;
import com.legends.edumia.dynamictrees.tree.species.Species;
import com.legends.edumia.dynamictrees.util.*;
...
public abstract class BranchBlock extends BlockWithDynamicHardness implements TreePart, FutureBreakable {
    ...
    public static Edumia.DestroyMode destroyMode = Edumia.DestroyMode.SLOPPY;
    ...
    public abstract boolean checkForRot(LevelAccessor level, BlockPos pos, Species species, int fertility, int radius,
                                        RandomSource rand, float chance, boolean rapid);
    ...
    public boolean canBeStripped(BlockState state, Level level, BlockPos pos, Player player, ItemStack heldItem) {
        ...
        return stripRadius != 0 && stripRadius <= this.getRadius(state) && this.canBeStripped &&
                heldItem.canPerformAction(ToolActions.AXE_STRIP);
    }
     ...
     */
    public BranchDestructionData destroyBranchFromNode(Level level, BlockPos cutPos, Direction toolDir, boolean wholeTree,
    ...
    public void rot(LevelAccessor level, BlockPos pos) {
        this.breakDeliberate(level, pos, Edumia.DestroyMode.ROT);
    }
     ...
     * @param mode  The {@link Edumia.DestroyMode} to destroy it with.
     */
    public void breakDeliberate(LevelAccessor level, BlockPos pos, Edumia.DestroyMode mode) {
        destroyMode = mode;
